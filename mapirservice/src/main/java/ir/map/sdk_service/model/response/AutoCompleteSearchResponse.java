...
import ir.map.sdk_service.model.other.SearchItem;

import static ir.map.sdk_service.main.MapirService.createGeom;
...
public class AutoCompleteSearchResponse extends MapirResponse {
    ...
    private AutoCompleteSearchResponse(int count, List<SearchItem> searchItems) {
        this.count = count;
    ...
    public static BaseModel createAutoCompleteSearchResponse(String data) {
        try {
            ...
            return new AutoCompleteSearchResponse(
