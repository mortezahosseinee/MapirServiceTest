...
import ir.map.sdk_service.model.other.Intersection;
import ir.map.sdk_service.model.other.Leg;
import ir.map.sdk_service.model.other.Maneuver;
import ir.map.sdk_service.model.other.RouteItem;
import ir.map.sdk_service.model.other.Step;
import ir.map.sdk_service.model.other.WayPoint;
