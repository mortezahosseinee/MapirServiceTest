...
import ir.map.sdk_service.models.enums.FilterOptions;
import ir.map.sdk_service.models.enums.SelectOptions;
...
public class SearchRequest {
    ...
    private SearchRequest(@NonNull String text, @NonNull List<SelectOptions> selects, @NonNull String filter, @NonNull Double latitude, @NonNull Double longitude) {
        this.text = text;
        this.filter = filter;
