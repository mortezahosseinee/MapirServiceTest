...
import ir.map.sdk_service.models.other.DistanceMatrixPointResponse;
import ir.map.sdk_service.models.other.ResultByDistance;
import ir.map.sdk_service.models.other.ResultByDuration;
...
public class DistanceMatrixResponse extends MapirResponse {
    ...
    public static BaseModel createDistanceMatrixResponse(String data) {
        try {
